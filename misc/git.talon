...
git branch <word>: "git branch {word}"
git checkout: "git checkout "
git checkout master: "git checkout master "
git checkout <word>: "git checkout {word}"
...
git merge: "git merge "
git merge <word>: "git merge {word}"
get merge abort: "git merge --abort "
git move: "git mv "
...
git pull <word>: "git pull {word} "
git push: "git push "
git push origin: "git push origin "
git push up stream origin: "git push -u origin"
git push <word>: "git push {word} "
