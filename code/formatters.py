...
formatters_words = {
    ...
    # TODO: decide between stroke, spine, & kebab
    "stroke": formatters_dict["DASH_SEPARATED"],
    ...
    "stringify": formatters_dict["DOUBLE_QUOTED_STRING"],
    "quotify": formatters_dict["SINGLE_QUOTED_STRING"],
